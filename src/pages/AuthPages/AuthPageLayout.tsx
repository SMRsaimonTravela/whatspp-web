  ...
  return (
    <div className="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      <div className="relative flex flex-col justify-center w-full h-screen lg:flex-row dark:bg-gray-900 sm:p-0">
        {children}
        <div className="items-center hidden w-full h-full lg:w-1/2 bg-gradient-to-br from-[#075E54] via-[#128C7E] to-[#25D366] dark:from-[#054d44] dark:via-[#0d6b5e] dark:to-[#1da851] lg:grid">
          <div className="relative flex items-center justify-center z-1">
            ...
            <div className="flex flex-col items-center max-w-sm px-6">
              ...
              <p className="text-center text-white/80 text-lg leading-relaxed">
                Intelligent WhatsApp Auto-Reply System for Travel Hosts
              </p>
